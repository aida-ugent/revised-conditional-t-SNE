...
class AnnoyIndexInterface {
 public:
  ...
  virtual void get_nns_by_item(const T* w, size_t n, size_t search_k, vector<S>* result, vector<T>* distances) const = 0;
...
public:
  ...
  void get_nns_by_item(const T* w, size_t n, size_t search_k, vector<S>* result, vector<T>* distances) const {
    // search for neighbors of a node which might not be part in the tree
